...
using Nop.Plugin.Payments.YunShanFu.Controllers;
...
{
    /// <summary>
    /// HygainsA payment processor
    /// </summary>
    public class HygainsAPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public bool CanRePostProcessPayment(Order order)
        {
            ...
            //HygainsA is the redirection payment method
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            controllerName = "YunShanFu";
            routeValues = new RouteValueDictionary { { "Namespaces", "Nop.Plugin.Payments.YunShanFu.Controllers" }, { "area", null } };
        }
        ...
        {
            return typeof(YunShanFuController);
        }
