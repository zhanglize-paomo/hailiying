...
using Nop.Plugin.Payments.HygainsA.Controllers;
...
namespace Nop.Plugin.Payments.HygainsA
{
    ...
    public class HygainsAPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            controllerName = "PaymentHygainsA";
            routeValues = new RouteValueDictionary { { "Namespaces", "Nop.Plugin.Payments.HygainsA.Controllers" }, { "area", null } };
        }
        ...
        {
            return typeof(PaymentHygainsAController);
        }
