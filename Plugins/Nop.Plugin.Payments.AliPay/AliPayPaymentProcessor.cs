...
namespace Nop.Plugin.Payments.AliPay
{
    ...
    public class AliPayPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public override void Install()
        {
            ...
            //locales
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.AliPay.RedirectionTip", "您将前往付款页面");
            ...
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.AliPay.PaymentMethodDescription", "您将使用支付宝扫码支付");
